...
modelname = fsp.train_primme(trainset, num_eps=1000, obs_dim=9, act_dim=9, lr=5e-5, reg=1, if_miso=False, plot_freq=1)
   

ic, ea, _ = fs.voronoi2image(size=[128,128,128], ngrain=2**12)
